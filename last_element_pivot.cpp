...
int main()
{
    ...
    cout << "LAST PIVOT for RANDOM ARRAY"<<endl;
    ...
    quickSortLast(b, 0, n - 1);
    clock_t end2=clock(); 
    double time2= double(end2 - start2)/ CLOCKS_PER_SEC*1000000;


    cout << "LAST PIVOT for SORTED ARRAY"<<endl;
    cout << "Comparisons = " << comparisons << endl;
    cout << "Swaps = " << swaps << endl;
    cout << "Calls = " << calls << endl;
    ...
    quickSortLast(c, 0, n - 1);
    clock_t end3=clock(); 
    double time3= double(end3 - start3)/ CLOCKS_PER_SEC*1000000;

    cout << "LAST PIVOT for REVERSE-SORTED ARRAY"<<endl;
    cout << "Comparisons = " << comparisons << endl;
    cout << "Swaps = " << swaps << endl;
    cout << "Calls = " << calls << endl;
    cout << "Time = " << time <<" microsenconds"<<endl;
